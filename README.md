...
This licensed means you cannot take this source code or a compiled version of the source code and include it in a commercial product. You are permited to use this tool to create a paid mod subject to the license agreements of Bethesda.
